...
## 6) Desafio Final
Pesquise e explique, em 3 linhas, a diferença entre `Named Export` e `Default Export` em Node.js com ESModules. Em seguida, monte um mini projeto com 3 arquivos (`dados.js`, `funcoes.js` e `index.js`) e teste a importação e a execução em terminal.
