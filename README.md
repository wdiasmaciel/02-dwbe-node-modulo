...
Crie um arquivo chamado `matematica.js` que exporte três constantes nomeadas: `pi`, `raio` e `areaCirculo`. Em seguida, importe essas constantes em um arquivo `app.js` e exiba a área de um círculo com raio 5. Para calcular a área de um círculo, utilize a fórmula A = π · r², em que A é a área, π (pi) vale aproximadamente 3,14 e r é o raio.
